...
(function($){
	...
	{
		width			: 960,					// set width - best to match image width
		height			: 560,					// set height - best to match image height
		image			: 'images/test-type-orange.png',	// set image path
		image2			: 'images/leaf-bg.png',	// set overlay image path - if set color is not used
		color			: null,			// set scratch color - if image2 is not set uses color
		overlay			: 'lighter',				// set the type of overlay effect 'none', 'lighter' - only used with color
